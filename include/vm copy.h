...
public:
    ...
    tuple<uint32_t, uint32_t> decodeRegisterAndImmediate(uint32_t operand);
    tuple<uint32_t, uint32_t> decodeTwoRegisters(uint32_t operand);
    tuple<uint32_t, uint32_t, uint32_t> decodeThreeRegisters(uint32_t operand);

    uint32_t encodeRegisterAndImmediate(uint32_t reg1, uint32_t immediate);
    uint32_t encodeTwoRegisters(uint32_t reg1, uint32_t reg2);
    uint32_t encodeThreeRegisters(uint32_t reg1, uint32_t reg2, uint32_t reg3);
